  ...
  <div className="relative z-10 max-w-6xl w-full text-center space-y-10">
    ...
    <div className="space-y-5 max-w-4xl mx-auto">
      ...
      <p className="text-slate-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
        Discover and book top-rated sports venues, turfs, and courts near you.
        Filter by sport, price, or location and secure your slot in seconds.
      </p>
    </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          >
            ...
            {
                allloc.map((res,index)=><option key={index} value={res}>{res}</option>)
            }
          </select>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          >
            <option value="All">ALL</option>
            {
                alltype.map((res,index)=><option key={index} value={res}>{res}</option>)
            }
          </select>
        </div>
      </div>
